...
export const initialContexts: Context[] = [
  {
    ...
    "upload": {
      ...
      "original_name": "Sales Team User Research - Meeting Pain Points - 2024-01-10.mp4",
      "content_type": "video/mp4",
      "upload_type": "video",
      "description": "User research session with 5 sales managers discussing meeting inefficiencies and note-taking challenges",
      "status": "completed",
      "priority": "high",
      "is_checkpoint": true,
      "recorded_on": "2024-01-10T14:00:00Z",
      "summary": "Sales teams lose 40% of meeting value due to poor note-taking, missed action items, and lack of CRM updates. Key insight: they need an 'invisible assistant' that captures everything without disrupting flow.",
      "participants": [
        "Tom Bradley",
        "Lisa Chen",
        "Marcus Johnson",
