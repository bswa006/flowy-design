...
export function useContextFocus({ editingId }: UseContextFocusProps): UseContextFocusReturn {
  const getFocusLevel = useCallback((contextId: string): MercuryFocusLevel => {
