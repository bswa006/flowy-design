...
import { MercuryDashboardCard, MercuryDashboardGrid } from '../mercury/mercury-dashboard-card'
...
export function MercuryDemo() {
  ...
  const handleMercuryAction = (intent: string) => {
    ...
    setActionLog(prev => [...prev.slice(-4), `${new Date().toLocaleTimeString()}: ${intent}`])
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
      ...
      <header className="mercury-module p-6 mb-8">
        <div className="max-w-7xl mx-auto">
          <h1 className="mercury-heading text-3xl mb-2" data-intent="page-title">
      ...
      <section className="max-w-7xl mx-auto p-6" data-intent="individual-examples">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div>
            <h3 className="mercury-caption mb-3">FOCUSED (Primary Attention)</h3>
          ...
          <div>
            <h3 className="mercury-caption mb-3">AMBIENT (Secondary Context)</h3>
            <MercuryDashboardCard
      ...
      <footer className="max-w-7xl mx-auto p-6 mt-12" data-intent="accessibility-info">
        <div className="mercury-card p-4">
