...
import { Mic, Download, Heart, MapPin, Calendar } from "lucide-react"
...
export function MercuryHousingModule({
  ...
  const handleLikeListing = (listingId: string) => {
    ...
    setActionFeedback(isNowLiked ? 'Added to favorites' : 'Removed from favorites')
        ...
        {actionFeedback && (
          ...
          >
            ...
            <motion.div
              ...
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
              transition={{ duration: 0.2, delay: 0.1, ease: wuWeiSpringEasing }}
            />
          </motion.div>
        )}
      </AnimatePresence>
