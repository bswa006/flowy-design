...
import { FlowyCard, FlowyCardContent, FlowyCardHeader, FlowyCardTitle } from "./flowy-card"
...
export class FlowyErrorBoundary extends React.Component<ErrorBoundaryProps, ErrorBoundaryState> {
...
function DefaultErrorFallback({ error, retry }: { error?: Error; retry: () => void }) {
  return (
    <FlowyCard variant="transparent" className="border-red-200/50 bg-red-50/30 dark:bg-red-950/30">
      <FlowyCardHeader>
      ...
      <FlowyCardContent>
        <div className="space-y-3">
          <p className="text-sm text-red-700 dark:text-red-200">
            {error?.message || "An unexpected error occurred while loading this card."}
          </p>
