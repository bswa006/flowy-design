...
export interface FlowyCardProps
...
export const FlowyCard = React.forwardRef<HTMLDivElement, FlowyCardProps>(
  (
    ...
    const mercuryVariants = {
      mercury:
        "bg-mercury-glass-300 border-mercury-border-200 backdrop-blur-mercury-md shadow-mercury-md",
      "mercury-elevated":
        "bg-mercury-glass-400 border-mercury-border-300 backdrop-blur-mercury-lg shadow-mercury-lg",
      "mercury-float":
        "bg-mercury-glass-300 border-mercury-border-200 backdrop-blur-mercury-lg shadow-mercury-float",
      "mercury-glass":
        "bg-gradient-to-br from-mercury-glass-400 to-mercury-glass-200 border-mercury-border-300 backdrop-blur-mercury-xl shadow-mercury-xl",
    };

    // Legacy variant styles for backward compatibility
    const legacyVariants = {
      default:
        "bg-flowy-glass border-flowy-border backdrop-blur-flowy shadow-flowy",
      elevated:
        "bg-white/60 border-white/30 backdrop-blur-flowy-md shadow-flowy-md",
      transparent:
        "bg-white/20 border-white/15 backdrop-blur-flowy shadow-flowy-sm",
      glass:
        "bg-gradient-to-br from-white/40 to-white/20 border-white/25 backdrop-blur-flowy-lg shadow-flowy",
    };
    ...
    const getMercuryShadow = () => {
      ...
      return variant === "mercury-float"
        ? "shadow-mercury-float"
        : variant === "mercury-elevated"
          ? "shadow-mercury-lg"
          : variant === "mercury-glass"
            ? "shadow-mercury-xl"
            : "shadow-mercury-md";
    };
...
>(({ className, mercury = true, ...props }, ref) => (
  <div
    ...
    className={cn(
      mercury
        ? "flex flex-col space-y-mercury-xs mb-mercury-md"
