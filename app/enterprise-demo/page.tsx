...
// Unused imports removed - they were part of the commented sample data
...
// Enterprise sample data with sophisticated metrics (unused for now)
...
export default function EnterpriseDemoPage() {
  ...
  const messageData = {
    ...
    messages: [
      ...
      {
        text: "Going well! Just finishing up the design system",
        timestamp: "11:22 PM",
        isOwn: true,
      },
      {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-slate-600 leading-relaxed max-w-3xl">
            Enterprise-grade components with focus hierarchy, status
            communication, and accessibility. Click any card to see
            Mercury's selective contrast system in action.
          </p>
        </div>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
            {/* Location Card */}
            <div
              onClick={() => handleFocusChange("location")}
              className="cursor-pointer"
            >
              <LocationCard
                intent="location"
            ...
            {/* Message Card */}
            <div
              onClick={() => handleFocusChange("message")}
              className="cursor-pointer"
            >
              <MessageCard
                intent="message"
            ...
            {/* Music Card */}
            <div
              onClick={() => handleFocusChange("music")}
              className="cursor-pointer"
            >
              <MusicCard
                intent="music"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-slate-600 leading-relaxed">
                Seamless interactions with natural easing curves. 700ms
                transitions with cubic-bezier(0.25,0.46,0.45,0.94) for Daoist
                inexertion principles.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-bold text-slate-800 mb-3">Focused</h3>
              <p className="text-slate-600 leading-relaxed">
                Clear visual hierarchy with selective contrast. Only ONE focused
                element at a time, with status communication through color
                within hierarchy.
              </p>
            </div>
            <div>
              ...
              <p className="text-slate-600 leading-relaxed">
                Intuitive patterns with WCAG 2.1 AAA accessibility. Keyboard
                navigation, screen reader support, and cognitive accessibility
                for all users.
              </p>
            </div>
          </div>
