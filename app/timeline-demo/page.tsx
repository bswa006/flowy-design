...
import { MercuryUploadsTimeline, TimelineUpload } from "@/components/mercury/mercury-uploads-timeline";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-600 font-medium max-w-2xl mx-auto leading-relaxed">
            A Mercury OS compliant timeline component for tracking upload progress
          </p>
        </div>
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl border border-slate-200/60 shadow-xl shadow-blue-200/20 p-6 transform scale-[1.02] ring-1 ring-blue-200/30">
              <div className="mb-4">
                <h3 className="text-lg font-semibold text-slate-800 mb-1">Focused State</h3>
                <p className="text-sm text-slate-600">Enhanced prominence with scale and shadows</p>
              </div>
              <MercuryUploadsTimeline
            ...
            <div className="bg-white rounded-2xl border border-slate-200/60 shadow-lg shadow-slate-200/30 p-6 opacity-40 scale-[0.98] blur-[0.5px]">
              <div className="mb-4">
                <h3 className="text-lg font-semibold text-slate-800 mb-1">Fog State</h3>
                <p className="text-sm text-slate-600">Reduced prominence for background context</p>
              </div>
              <MercuryUploadsTimeline
                intent="fog-timeline"
                focusLevel="ambient"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
            <div className="space-y-4">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h4 className="text-lg font-semibold text-slate-800">Required Props</h4>
              </div>
              <ul className="space-y-3 text-slate-700 leading-relaxed">
                <li className="flex items-start gap-3">
                  <span className="text-slate-400 mt-1">•</span>
                  <span><code className="bg-slate-100 px-2 py-0.5 rounded text-sm font-medium">intent</code> prop with data-intent attribute</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-slate-400 mt-1">•</span>
                  <span><code className="bg-slate-100 px-2 py-0.5 rounded text-sm font-medium">focusLevel</code> with three-tier hierarchy</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-slate-400 mt-1">•</span>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h4 className="text-lg font-semibold text-slate-800">Accessibility</h4>
              </div>
              <ul className="space-y-3 text-slate-700 leading-relaxed">
                <li className="flex items-start gap-3">
                  <span className="text-slate-400 mt-1">•</span>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h4 className="text-lg font-semibold text-slate-800">Animations</h4>
              </div>
              <ul className="space-y-3 text-slate-700 leading-relaxed">
                <li className="flex items-start gap-3">
                  <span className="text-slate-400 mt-1">•</span>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h4 className="text-lg font-semibold text-slate-800">Design Tokens</h4>
              </div>
              <ul className="space-y-3 text-slate-700 leading-relaxed">
                <li className="flex items-start gap-3">
                  <span className="text-slate-400 mt-1">•</span>
