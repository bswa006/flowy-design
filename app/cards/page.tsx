...
const FlowyCard = ({
  ...
  >
    <BaseFlowyCard size={size} variant="glass" mercury={false} {...props}>
      {children}
    </BaseFlowyCard>
  </motion.div>
);
    ...
    <div className="text-center space-y-6">
      ...
      <div className="space-y-3">
        ...
        <FlowingText size="sm" className="text-slate-600">
          Creating beautiful, intuitive experiences that flow naturally with
          human behavior.
        </FlowingText>
      </div>
  ...
  <FlowyCard delay={delay} className="max-w-sm">
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <FlowingText size="sm" className="text-slate-600">
          Capture life's flowing moments with crystal clarity and natural
          beauty.
        </FlowingText>
  ...
  <FlowyCard delay={delay} size="sm" className="max-w-md">
    <div className="flex items-start space-x-4">
      ...
      <div className="flex-1 space-y-3">
        ...
        <FlowingText size="sm" className="text-slate-600">
          Your design flows beautifully! The cards have that perfect weightless
    ...
    <div className="space-y-6">
      <div className="flex items-center space-x-4">
        ...
        <div className="space-y-1">
          <FlowingText
            size="xs"
            className="text-purple-600 font-medium uppercase tracking-wide"
          >
            Tomorrow
          </FlowingText>
          <FlowingText size="lg" className="text-slate-800 font-medium">
      ...
      <FlowingText size="sm" className="text-slate-600">
        Join us for an exploration of flowy design principles and how to create
        interfaces that feel naturally weightless.
      </FlowingText>
...
const ArticleCard = ({ delay = 0 }) => (
  <FlowyCard delay={delay} className="max-w-md">
    <div className="space-y-6">
      ...
      <FlowingText size="sm" className="text-slate-600">
        Discover how to create interfaces that flow like water, breathe with
        generous space, and feel weightless to interact with. Learn the
        principles that make design feel effortless.
      </FlowingText>
        ...
        <div className="max-w-6xl mx-auto px-8">
          ...
          >
            ...
            <FlowingText size="lg" className="text-slate-600 max-w-2xl mx-auto">
              A showcase of different card types, each following the same flowy
              principles: generous spacing, natural flow, graceful curves, and
              weightless interactions
            </FlowingText>
          </motion.div>
          ...
          <div className="mt-32 text-center">
            <FlowingText className="text-slate-500 italic">
              Each card flows naturally, breathes with space, and feels
              weightless to interact with
            </FlowingText>
          </div>
        </div>
      </div>
