  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "flowy-md":
          "0 8px 20px rgba(0, 0, 0, 0.06), 0 3px 6px rgba(0, 0, 0, 0.04)",
        "flowy-lg":
          "0 12px 28px rgba(0, 0, 0, 0.08), 0 4px 8px rgba(0, 0, 0, 0.05)",
        "flowy-xl":
          "0 16px 40px rgba(0, 0, 0, 0.10), 0 6px 12px rgba(0, 0, 0, 0.06)",
        "flowy-float":
          "0 20px 60px rgba(0, 0, 0, 0.12), 0 8px 16px rgba(0, 0, 0, 0.08)",
        "flowy-dark":
          "0 4px 16px rgba(0, 0, 0, 0.15), 0 1px 3px rgba(0, 0, 0, 0.10)",
      },
